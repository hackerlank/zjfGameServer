...
public class ScienceGetOfferScienceAwardAction implements ActionSupport{
	...
	public void execute(Message message, IoSession session) {
		...
		int startTimeId = message.getInt();
		msg = scienceService.getOfferScienceAward(role, startTimeId);
		if(msg == null)
		{
			return;
		}else {
